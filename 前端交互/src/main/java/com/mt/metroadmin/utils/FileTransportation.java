...
public class FileTransportation {
    ...
    public  String fileUpload(MultipartFile file,String filepath) throws Exception {
        // 首先校验图片格式
        List<String> imageType = Lists.newArrayList("jpg","jpeg", "png", "bmp", "gif","mp3");
        ...
        if (imageType.contains(fileSuffix)) {
            ...
            String path = File.separator + filepath + File.separator + newFileName;
