...
*/
    ...
    private Map<String, RedisCacheConfiguration> getRedisCacheConfigurationMap() {
        ...
        redisCacheConfigurationMap.put("friends", this.getRedisCacheConfigurationWithTtl(2 * 60 * 60));
        redisCacheConfigurationMap.put("achieve", this.getRedisCacheConfigurationWithTtl(Time.getRefreshTime()));//自定义设置缓存时间
